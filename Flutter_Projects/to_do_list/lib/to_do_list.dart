...
class _todoState extends State<todo> {
  ...
  List tasks = [ 'Learning','Practice Statfullclass',
  'Pray on time','Play Football','Gym','Wake up early','Charge the devices' ,'Update version'];
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: ListTile(
                    splashColor: const  Color.fromARGB(255, 122, 75, 4),
